...
def test_ragged_empty():
    ...
    assert_allclose(ragged[:0].data, ragged.data)
    assert_allclose(ragged[:0].lengths, ragged.lengths)
    assert_allclose(ragged[:2].data, ragged.data)
    assert_allclose(ragged[:2].lengths, ragged.lengths)
